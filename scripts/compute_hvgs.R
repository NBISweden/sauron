...
compute_hvgs <- function(object,VAR_choice,output_path,assay="RNA"){
  ...
  if(casefold(VAR_choice[1]) == "no"){
    ...
    write.csv2(object@assays[[assay]]@meta.features, paste0(output_path,"/HVG_info_seurat.v3.csv"))
    
    png(filename = paste0(output_path,"/Var_vst_exp_disp_gene_selection_seurat.v3.png"),width = 1000,height = 1050,res = 200)
    ...
    png(filename = paste0(output_path,"/Var_vst_mean_disp_gene_selection_seurat.v3.png"),width = 1000,height = 1050,res = 200)
